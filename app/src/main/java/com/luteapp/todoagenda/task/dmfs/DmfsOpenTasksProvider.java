...
import com.luteapp.todoagenda.task.TaskStatus;
...
public class DmfsOpenTasksProvider extends AbstractTaskProvider {
    ...
    public List<TaskEvent> queryTasks() {
        ...
        return myContentResolver.foldEvents(DmfsOpenTasksContract.Tasks.PROVIDER_URI, projection, where, null, null,
    ...
    public Intent newViewEventIntent(TaskEvent event) {
        return IntentUtil.newViewIntent().setData(ContentUris.withAppendedId(DmfsOpenTasksContract.Tasks.PROVIDER_URI, event.getEventId()));
    }
